...
QT_MOC_LITERAL(1, 9, 16), // "startTimeUpdated"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12) // "endRunUpdate"

    },
    "messages\0startTimeUpdated\0\0endRunUpdate"
};
...
void messages::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startTimeUpdated((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->endRunUpdate((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (messages::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&messages::startTimeUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (messages::*)(double , unsigned int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&messages::endRunUpdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void messages::startTimeUpdated(double _t1)
{
...
// SIGNAL 1
void messages::endRunUpdate(double _t1, unsigned int _t2, double _t3)
{
